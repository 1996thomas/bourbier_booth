...
import ScenePS2,    { drawForCapture as drawPS2,    WEBCAM_STYLE as webcamPS2,    drawBackground as drawBgPS2, WEBCAM_CAPTURE_RECT as webcamRectPS2 } from "./scenes/ScenePS2";
import SceneMSN,    { drawForCapture as drawMSN,    WEBCAM_STYLE as webcamMSN    } from "./scenes/SceneMSN";
...
export const SCENES = [
  ...
  { name: "PS2",    component: ScenePS2,    draw: drawPS2,    webcam: webcamPS2,    drawBackground: drawBgPS2,   webcamRect: webcamRectPS2     },
  { name: "MSN",    component: SceneMSN,    draw: drawMSN,    webcam: webcamMSN,    drawBackground: undefined,  webcamRect: undefined         },
